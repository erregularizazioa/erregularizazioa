...
| Datos de contacto y notificaciones | **Implementado con cautela** | `preguntas-y-respuestas-actualizado.md:310-317` | La ficha ya distingue contacto principal, representante y destino preferente de notificaciones; queda pendiente validar si hace falta mayor detalle documental del apoderamiento. | `logic.js`, `app.js`, `index.html`, `db.js` | Media-alta | Revisar con personas expertas si conviene exigir o recordar prueba de representacion en determinados supuestos. |
